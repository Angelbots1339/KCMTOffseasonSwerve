...
public final class CTREConfigs {
    ...
    public TalonFXConfiguration getAngleMotorConfig(SwerveModuleConstants moduleConstants) {
    ...
    public TalonFXConfiguration getDriveMotorConfig(SwerveModuleConstants moduleConstants) {
    ...
    public CANCoderConfiguration getCanCoderConfig(SwerveModuleConstants moduleConstants) {

        CANCoderConfiguration swerveCanCoderConfig = new CANCoderConfiguration();

        swerveCanCoderConfig.absoluteSensorRange = AbsoluteSensorRange.Unsigned_0_to_360;
        swerveCanCoderConfig.sensorDirection = moduleConstants.canCoderInvert;
        swerveCanCoderConfig.magnetOffsetDegrees = moduleConstants.angleOffset;
