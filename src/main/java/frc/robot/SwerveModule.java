...
public class SwerveModule {
    ...
    private void configAngleEncoder(){        
        ...
        angleEncoder.configAllSettings(Robot.ctreConfigs.getCanCoderConfig(moduleConstants));
    }

    private void configAngleMotor(){

        mAngleMotor.configFactoryDefault();
        mAngleMotor.configAllSettings(Robot.ctreConfigs.getAngleMotorConfig(moduleConstants));
        mAngleMotor.setInverted(moduleConstants.angleMotorInvert);
    ...
    private void configDriveMotor(){
        ...
        mDriveMotor.configAllSettings(Robot.ctreConfigs.getDriveMotorConfig(moduleConstants));
